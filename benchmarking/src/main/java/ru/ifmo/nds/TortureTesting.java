...
public class TortureTesting {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<NonDominatedSortingFactory> sortingFactories = Arrays.asList(
                ...
                DeductiveSort.getOriginalImplementationV2(),
                DeductiveSort.getOriginalImplementationV3(),
                DeductiveSort.getRandomizedOriginalImplementationV3(),
                ...
                DeductiveSort.getDeterministicQuadraticImplementationV4(),
                DeductiveSort.getArenaPrinciple(),
