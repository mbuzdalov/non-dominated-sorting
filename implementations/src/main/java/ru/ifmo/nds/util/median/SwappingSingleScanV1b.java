...
public final class SwappingSingleScanV1b implements DestructiveMedianFactory {
    private static final SwappingSingleScanV1b factoryInstance = new SwappingSingleScanV1b();

    public static SwappingSingleScanV1b instance() {
