...
public class JensenFortinBuzdalov {
    ...
    public static NonDominatedSortingFactory getRedBlackTreeSweepHybridBOSImplementation(int allowedThreads) {
        return (p, d) -> new RedBlackTreeSweepHybridBOS(p, d, allowedThreads);
    }
}
