...
public class JensenFortinBuzdalov {
    ...
    public static NonDominatedSortingFactory getRedBlackTreeSweepHybridNDTImplementation(int allowedThreads) {
        return (p, d) -> new RedBlackTreeSweepHybridNDT(p, d, allowedThreads);
    }
}
