...
public class VanEmdeBoasSweepHybridENS extends VanEmdeBoasSweep {
    ...
    public VanEmdeBoasSweepHybridENS(int maximumPoints, int maximumDimension) {
    ...
    public String getName() {
        return "Jensen-Fortin-Buzdalov sorting, " + getThreadDescription() + " (vEB sweep, hybrid with ENS)";
    }
