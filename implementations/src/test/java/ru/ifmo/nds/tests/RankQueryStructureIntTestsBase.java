...
public abstract class RankQueryStructureIntTestsBase {
    protected abstract RankQueryStructureInt createStructure(int maximumPoints);
    ...
    public void randomSmokeTesting() {
        ...
        for (int upperBound : new int[] { 30, 60, 1024, 2048, 4096, 8192, 16012, 32716}) {
            RankQueryStructureInt structure = createStructure(upperBound);
            ...
            for (int times = 0; times < 10; ++times) {
                ...
                RankQueryStructureInt.RangeHandle handle = structure.createHandle(0, 0, differentPoints, indices, keys);
                Arrays.sort(keys);
