...
public abstract class CorrectnessTestsBase {
    ...
    @Test
    public void someHybridsFailThis() {
        double[][] input = new double[][]{
                {0.6762296272878019, -0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019, 0.6762296272878019},
                {0.23363882905744304, -0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304, 0.23363882905744304},
                {0.5052161730545899, -0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899, 0.5052161730545899},
                {0.7316642357061648, -0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648, 0.7316642357061648},
                {0.32836900814145464, -0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464, 0.32836900814145464},
                {0.9907838289789052, -0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052, 0.9907838289789052},
                {0.8252243709342835, -0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835, 0.8252243709342835},
                {0.5398617395584094, -0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094, 0.5398617395584094},
                {0.9881534624483833, -0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833, 0.9881534624483833},
                {0.47297858766176437, -0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437, 0.47297858766176437},
        };
        int[] output = new int[input.length];
        NonDominatedSortingFactory factory = getFactory();
        NonDominatedSorting sorting = factory.getInstance(input.length, input[0].length);
        for (int times = 0; times < 1000; ++times) {
            sorting.sort(input, output);
            for (int rank : output) {
