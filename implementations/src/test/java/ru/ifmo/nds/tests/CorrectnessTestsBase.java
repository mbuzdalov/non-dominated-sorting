...
public abstract class CorrectnessTestsBase {
    ...
    public void generatedTest9() throws Exception {
        ...
        int[] ranks = new int[]{
                3, 2, 2, 1, 5, 6, 0, 0, 3, 6, 6, 1, 2, 2, 0, 1, 1, 5, 5, 3, 3, 1, 5, 5, 2, 6, 0, 1, 6, 5, 3, 4, 1, 3, 2, 5, 6, 1, 6, 5, 6, 2, 3, 4, 6, 4, 6, 3, 3, 3, 2, 0, 0, 5, 6, 2, 5, 5, 5, 5, 5, 1, 3, 4, 2, 4, 2, 3, 0, 6, 1, 1, 6, 4, 2, 6, 4, 1, 5, 1, 4, 6, 2, 3, 6, 6, 4, 3, 3, 2, 3, 3, 3, 3, 0, 2, 5, 6, 5, 3, 2, 6, 1, 5, 5, 3, 6, 2, 2, 2, 4, 3, 4, 6, 2, 2, 4, 3, 4, 6, 6, 0, 5, 4, 0, 2, 4, 5, 4, 1, 3, 1, 5, 2, 3, 2, 1, 1, 1, 5, 4, 4, 6, 5, 5, 0, 0, 0, 6, 4, 4, 5, 6, 3, 2, 3, 3, 2, 2, 5, 0, 2, 4, 6, 1, 5, 2, 5, 4, 3, 4, 4, 4, 3, 4, 5, 3, 5, 5, 5, 2, 5, 2, 3, 2, 5, 3, 4, 4, 3, 3, 4, 6, 0, 1, 2, 6, 6, 4, 0, 3, 2, 2, 0, 0, 2, 6, 2, 2, 2, 1, 5, 0, 4, 3, 4, 3, 4, 4, 3, 5, 5, 4, 4, 6, 2, 5, 3, 0, 3, 4, 5, 3, 2, 5, 3, 3, 0, 4, 5, 4, 5, 2, 6, 3, 4, 1, 1, 5, 5, 2, 1, 3, 3, 0, 5, 1, 4, 5, 3, 5, 1, 1, 4, 2, 3, 5, 4, 3, 5, 0, 3, 5, 0, 1, 2, 3, 0, 2, 2, 1, 1, 4, 3, 5, 0, 4, 0, 3, 3, 5, 0, 6, 2, 4, 3, 1, 5, 3, 3, 4, 4, 3, 4, 1, 3, 5, 1, 5, 6, 0, 4, 4, 5, 4, 1, 2, 6, 5, 4, 4, 1, 2, 5, 5, 4, 2, 4, 6, 1, 4, 0, 6, 1, 2, 5, 5, 6, 2, 6, 1, 1, 0, 3, 4, 6, 0, 1, 6, 6, 0, 4, 4, 4, 5, 6, 5, 3, 5, 6, 1, 1, 3, 2, 4, 5, 3, 4, 5, 6, 1, 2, 0, 5, 6, 1, 3, 3, 4, 4, 4, 2, 4, 6, 4, 3, 5, 1, 5, 6, 4, 1, 0, 5, 4, 1, 6, 3, 3, 2, 4, 1, 2, 6, 3, 0, 2, 3, 6, 2, 2, 4, 0, 6, 4, 5, 2, 3, 6, 3, 0, 5, 1, 0, 3, 5, 4, 4, 0, 0, 5, 3, 4, 0, 1, 3, 0, 5, 1, 3, 2, 3, 4, 0, 5, 6, 2, 0, 6, 3, 5, 1, 3, 3, 6, 4, 4, 3, 2, 6, 3, 6, 2, 2, 3, 0, 5, 3, 5, 0, 5, 1, 6, 0, 5, 5, 2, 5, 0, 4, 2, 2, 2, 6, 4, 1, 0, 6, 4, 1, 3, 2, 4, 4, 0, 1, 6, 3, 4, 1, 5, 0, 3, 1, 3, 2, 1, 2, 5
        };
    ...
    public void generatedTest10() throws Exception {
        groupCheck(new double[][] {
                {9, 9, 6}, {4, 3, 7}, {2, 7, 9}, {2, 11, 0}, {16, 3, 1}, {1, 11, 9}, {4, 17, 18}, {4, 2, 6}, {0, 14, 5},
                {1, 16, 14}, {12, 7, 12}, {0, 1, 19}, {0, 15, 4}, {19, 3, 18}, {17, 14, 13}, {7, 8, 18}, {13, 1, 13},
                {7, 16, 1}, {14, 7, 10}, {17, 14, 18}, {2, 6, 10}, {18, 2, 2}, {16, 13, 1}, {5, 1, 15}, {13, 14, 4},
                {16, 16, 10}, {5, 7, 1}, {13, 14, 1}, {12, 0, 11}, {6, 15, 15}, {17, 16, 13}, {4, 2, 11}, {8, 1, 0},
                {10, 13, 0}, {17, 4, 3}, {3, 16, 11}, {14, 15, 4}, {4, 14, 2}, {8, 12, 17}, {6, 4, 18}, {11, 10, 1},
                {11, 18, 14}, {1, 3, 0}, {9, 4, 1}, {15, 13, 1}, {6, 13, 13}, {17, 7, 12}, {0, 16, 18}, {18, 10, 8},
                {1, 15, 15}, {18, 2, 12}, {12, 9, 9}, {9, 7, 0}, {16, 4, 4}, {6, 9, 6}, {1, 13, 1}, {19, 7, 4},
                {19, 16, 11}, {3, 8, 11}, {15, 15, 15}, {18, 3, 19},
        }, new int[] {
                3,1,1,1,1,1,4,0,0,2,
                2,0,0,3,5,3,1,2,2,6,
                1,1,4,0,4,6,1,3,0,4,
